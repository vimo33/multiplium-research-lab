  ...
  },
  {
    ...
    body: {
      ...
      rows: [
        ...
        ["3",  "Sencrop",                "Precision Viticulture"],
        ["4",  "Agrology",               "Carbon MRV / Traceability"],
        ["5",  "Pacific Biochar",        "Soil Health / Biologicals"],
        ["6",  "EZ Lab - Wine Blockchain","Carbon MRV / Traceability"],
        ["7",  "Arable",                 "Precision Viticulture"],
        ["8",  "Cérience",               "Soil Health / Biologicals"],
        ["9",  "MyEasyFarm",             "Carbon MRV / Traceability"],
        ["10", "ClimateHound",           "Carbon MRV / Traceability"],
        ["11", "Deep Planet",            "Precision Viticulture"],
        ["12", "Bioplanet",              "Pest Management"],
        ["13", "Mycophyto",              "Soil Health / Biologicals"],
        ["14", "BioStart (Mycorrcin)",   "Soil Health / Biologicals"],
        ["15", "FarmLab",                "Carbon MRV / Traceability"],
        ["16", "WiseConn",               "Irrigation Optimisation"],
        ["17", "Kilimo",                 "Irrigation Optimisation"],
        ["18", "SupPlant",               "Irrigation Optimisation"],
        ["19", "ISCA Technologies",      "Pest Management"],
        ["20", "UAV-IQ",                 "Pest Management"],
      ],
    },
  },
  {
    ...
    body: {
      ...
      items: [
        ...
        { rank: 3,  name: "Sencrop",               note: "Hyper-local weather network, disease pressure prediction" },
        { rank: 4,  name: "Agrology",              note: "Real-time soil carbon monitoring, sequestration tracking" },
        { rank: 5,  name: "Pacific Biochar",       note: "Biochar soil amendment, water retention and carbon sequestration" },
        { rank: 6,  name: "EZ Lab - Wine Blockchain", note: "Blockchain traceability for wine supply chain transparency" },
        { rank: 7,  name: "Arable",                note: "Precision crop monitoring platform, strong vineyard traction" },
        { rank: 8,  name: "Cérience",              note: "Soil health SaaS, actionable agronomic insights" },
        { rank: 9,  name: "MyEasyFarm",            note: "Farm management + carbon MRV platform for growers" },
        { rank: 10, name: "ClimateHound",          note: "Carbon accounting and ESG reporting for agricultural operations" },
      ],
    },
  },
  {
